import vk_api
	...
	from bd import engine, Session, write_msg, register_user, add_user, add_user_photos, add_to_black_list, \
	    ...
	    while True:
	        ...
	        if msg_text == "vkinder":
	            ...
	            """Поиск партнера"""
	                ...
	                if int(age_at) < 18:
	                    write_msg(user_id, 'Допустимый возраст - от 18 лет!')
	                    age_at = 18
	                ...
	                for i in range(len(result)):
	                    ...
	                    """Получение фото и сортировка по лайкам"""
	                    ...
	                    """Ждем, когда пользователь введет данные"""
